...
interface OutputSectionProps {
  ...
  showKeywords?: boolean; // New prop to control keyword tables visibility
}
...
const OutputSection: React.FC<OutputSectionProps> = ({ 
  ...
  showKeywords = false // Default to false if not provided
}) => {
  ...
  const sortedKeywords = [...sampleKeywords].sort((a: any, b: any) => {
  ...
  const sortedBenchmarks = [...sampleBenchmarks].sort((a: any, b: any) => {
    if (sortConfig.column === null) return 0;
            ...
            <>
              ...
              <div className="pt-4 border-t border-border animate-fade-in">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <button
                    type="button"
                    onClick={() => copyToClipboard(JSON.stringify(sampleKeywords, null, 2), "Keyword Data")}
                    className="inline-flex items-center gap-1 text-xs text-muted-foreground hover:text-primary transition-colors p-1 rounded focus-ring"
              ...
              <div className="pt-4 border-t border-border animate-fade-in">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <button
                    type="button"
                    onClick={() => copyToClipboard(JSON.stringify(sampleBenchmarks, null, 2), "Benchmark Data")}
                    className="inline-flex items-center gap-1 text-xs text-muted-foreground hover:text-primary transition-colors p-1 rounded focus-ring"
